...
\noindent
Basically, having an expression of this structure specfically:\\
\begin{equation*}
     \alpha_{t,2} = a\cdot\alpha_{t,1}+b
\end{equation*}
is enough to get rid of the unknown $\alpha_{t,1}$ algebraically, replacing the rewind with a direct sub.
\end{solution}
